...
```{r}
g2 <- ggplot(data = CIACountries, aes(y = gdp, x = educ)) + xlab("% of GDP Spent on Education") + ylab("Gross Domestic Product (GDP)")
...
```{r}
g3 <- ggplot(data = CIACountries, aes(y = gdp, x = educ)) + xlab("% of GDP Spent on Education") + ylab("Gross Domestic Product (GDP)")

g3 + geom_text(aes(label = country, color = net_users, size = 3)) + theme(legend.position = "top")
...
```{r}
g4 <- ggplot(data = CIACountries, aes(y = gdp, x = educ)) + xlab("% of GDP Spent on Education") + ylab("Gross Domestic Product (GDP)")

g4 + geom_text(aes(label = country, color = net_users, size = 3)) + theme(legend.position = "top") + coord_trans(y = "log10")
```
