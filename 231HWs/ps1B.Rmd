...
> In terms of cooridnate systems, this one cannot really be defined with the books taxonomy, as though the data is presented in a circle there is not really a coordinate grid made up from this circle, it is just employed in order display all of the majors and job fields in one place.
...
```{r}
g <-ggplot(data = storms, aes(x=long, y = lat, color = name)) + geom_path() + 
